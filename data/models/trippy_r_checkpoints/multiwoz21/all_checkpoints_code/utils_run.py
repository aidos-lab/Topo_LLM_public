...
def print_header():
    logger.info(" _________  ________  ___  ________  ________  ___    ___        ________     ")
    logger.info("|\___   ___\\\   __  \|\  \|\   __  \|\   __  \|\  \  /  /|      |\   __  \    ")
    logger.info("\|___ \  \_\ \  \|\  \ \  \ \  \|\  \ \  \|\  \ \  \/  / /______\ \  \|\  \   ")
    logger.info("     \ \  \ \ \   _  _\ \  \ \   ____\ \   ____\ \    / /\_______\ \   _  _\  ")
    logger.info("      \ \  \ \ \  \\\  \\\ \  \ \  \___|\ \  \___|\/  /  /\|_______|\ \  \\\  \| ")
    logger.info("       \ \__\ \ \__\\\ _\\\ \__\ \__\    \ \__\ __/  / /             \ \__\\\ _\ ")
    logger.info("        \|__|  \|__|\|__|\|__|\|__|     \|__||\___/ /               \|__|\|__|")
...
def load_and_cache_examples(args, model, tokenizer, processor, dset="train", evaluate=False, automatic_labels=None):
    ...
    dataset = TrippyDataset(args, examples=None, model=model, tokenizer=tokenizer, processor=processor, dset=dset, evaluate=evaluate,
    ...
    if os.path.exists(cached_file) and not args.overwrite_cache and not args.no_cache:
        ...
        processor_args = {'no_label_value_repetitions': args.no_label_value_repetitions,
