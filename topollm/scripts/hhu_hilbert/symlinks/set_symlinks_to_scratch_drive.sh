...
# This script sets symbolic links form the project directory to the HHU Hilbert scratch drive from intermediate data directories in our local topological features computation.
...
# Notes: 
# - This needs to be run on the HHU Hilbert cluster.
