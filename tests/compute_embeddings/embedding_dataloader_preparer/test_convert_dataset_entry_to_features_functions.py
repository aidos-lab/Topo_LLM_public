...
dataset_entry_luster_data_example: dict[
    ...
    "source_target": [
        " user : i am looking for a place to dine. the restaurant should serve hungarian food and should be in the south.</s> emotion : neutral</s> domain : restaurant</s> state : food hungarian ; price range unknown ; name unknown ; area south ; book time unknown ; book day unknown ; book people unknown</s> database : no entity found in database</s> </s> conduct : apologetic</s> system : regretfully, we have nothing like that in the south.</s>",  # noqa: E501
